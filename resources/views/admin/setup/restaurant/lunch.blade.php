        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#">Restaurant Lunch Menu</a>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form" method="post" action="{{ route('restaurant.lunch',$data->id) }}" enctype="multipart/form-data">@csrf
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-icon btn-outline-danger btn-sm" title="Inactive" 
                                                    onclick="deleteData('{{ route('restaurantLunchItem.delete', [$item->id]) }}')">
        ...
        <div class="modal fade text-left" id="editItem" tabindex="-1" role="dialog" 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route ('restaurantLunchItem.update')}}" method="post"  class="clearForm form" 
